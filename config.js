...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '2349130476348-1632403322@g.us',
    ...
    RG: process.env.RG || '2349130476348-1632403322@g.us,120363116963909366@g.us',
    ...
    ALLOWED: process.env.ALLOWED || '234,234,234',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "infexjay",
    BOT_NAME: process.env.BOT_NAME || 'infexjay',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Infex MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
